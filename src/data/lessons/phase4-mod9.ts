...
এই পুরো প্রসেসে আপনি মাত্র ৪০ মিনিট কাজ করলেন, বাকি সব AI করেছে — কিন্তু কোয়ালিটি প্রোফেশনাল লেভেলের!
  ...
  labData: {
    title: "SDD Lifecycle Visualizer",
    ...
    tasks: [
      { id: 0, label: 'Parse SPEC.md & Architectural Rules', status: 'done', icon: 'FileText' },
      { id: 1, label: 'Schema Design & DB Models', status: 'done', icon: 'Database' },
      { id: 2, label: 'Backend API Implementation', status: 'success', icon: 'Code' },
      { id: 3, label: 'Frontend Component Assembly', status: 'processing', icon: 'Monitor' },
      { id: 4, label: 'Automated Test Suite Execution', status: 'pending', icon: 'ShieldCheck' },
    ]
  }
};
